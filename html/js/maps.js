...
class GoogleMaps {
	constructor() {
		...
		if (!window.GoogleMaps) {
			this.callbackName = 'GoogleMaps.Loaded';
			window.GoogleMaps = this;
			window.GoogleMaps.Loaded = this.LoadedMaps.bind(this);
		}
	}
	...
	LoadedMaps() {
		this.center = new google.maps.LatLng(DEFAULT_LAT,DEFAULT_LNG);
		...
		this.map.addListener("center_changed", () => {
			...
			console.log("Zoome=" + this.map.getZoom());
		});
	}
